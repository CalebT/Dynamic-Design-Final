...
function ClickToggle() {
    if (togglestate ===  0) {
        ...
        document.querySelector(".info").style.height = "28vh";
        togglestate = 1;
...
const img1 = require('../../Imgs/formosan1.jpg');
const img2 = require('../../Imgs/formosan2.jpg')
...
<SidebarMenu/>
    <div className='animal_header'>
        <Header color='#0d6d0d' text='Formosan Black Bear' fontSize='22pt'/>
    </div>
